<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateTrainer.aspx.cs" Inherits="HRMSTeam3.Training.UpdateTrainer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="container">
        <div class="form-section">
            <h3 class="mb-4">Update Trainer</h3>
            ...
            <div class="text-end">
                <asp:Button ID="Button2" runat="server" Text="Update Trainer" OnClick="Button2_Click" CssClass="btn btn-custom" />
            </div>
        </div>
    </div>
</asp:Content>

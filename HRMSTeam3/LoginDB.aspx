                    ...
                    <form>
                      ...
                      <div data-mdb-input-init class="form-outline mb-4">
                        <%--<input type="email" id="form1Example13" class="form-control form-control-lg" />--%>
                         <asp:TextBox class="form-control form-control-lg"  ID="TextBox1" runat="server" TextMode="Password"></asp:TextBox>
                      ...
                      <div data-mdb-input-init class="form-outline mb-4">
                        <%--<input type="password" id="form1Example23"  />--%>
                          <asp:TextBox class="form-control form-control-lg" ID="TextBox2" runat="server" TextMode="Password"></asp:TextBox>
